                    ...
                    <div className="mx-auto flex h-16 max-w-screen-2xl items-center justify-between sm:px-6 lg:px-8">
                        <div className="flex items-center gap-4">
                            ...
                            <a href="/" className="flex">
                                <span className="inline-block w-[120px] "><img className=''
                                    src="https://res.cloudinary.com/dwp7umncy/image/upload/v1689746163/shopinterior/form/logohome_kx0qqn.png"
                                    alt="" /></span>
                            </a>
                        </div>
                            ...
                            <div className="flex items-center">
                                <div className="flex items-center border-x border-gray-100">
                                    <span className="border-e border-e-gray-100">
                                        <Link to={`/cart`} className="grid h-16 w-16 place-content-center border-b-4 border-transparent hover:border-red-700">
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            <div className="flex justify-center text-teal-600 sm:justify-start">
                                <img width={'20%'} src="https://res.cloudinary.com/dwp7umncy/image/upload/v1689746163/shopinterior/form/logohome_kx0qqn.png" alt="" />
                                <p className='pt-[20px]'>SHOPINTERIOR</p>
                            </div>

                            <p
                                className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left"
                            >
                                We sell imported items from Europe to Vietnam. Many celebrities use my products.
                            </p>
                            ...
                            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                                <li>
                                    <a
                                        ...
                                        rel="noreferrer"
                                        target="_blank"
                                        className="text-[#1677ff] transition hover:text-teal-700/75"
                                    >
                                ...
                                <ul className="mt-8 space-y-4 text-sm">
                                    <li>
                                        ...
                                        >
                                            ...
                                            <span className="text-gray-700">mh@gmail.com</span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        >
                                            ...
                                            <span className="text-gray-700">0858879***</span>
                                        </a>
                                    </li>
